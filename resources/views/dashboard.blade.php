...
@section('content')
    ...
    <section class="bg-dark bg-cover text-white text-center min-vh-100 d-flex justify-content-center align-items-center" style="background-image: url('{{ asset('assets/img/caffe.jpg') }}'); background-size: cover; background-position: center;">
        ...
        <div class="content">
            <img src="{{ asset('assets/img/caffeine-light.png') }}" alt="caffeine" class="mb-4" style="width:auto; height:150px;"> 
            <h1 class="fw-semibold">Welcome !</h1>
            <a href="{{ route('user.menu') }}" 
            class="btn" 
            style="background-color: #E3DAC9; color: #000; border: none; padding: 10px 20px; border-radius: 5px; text-decoration: none;">
                Find a Table
            </a>
        </div>
        ...
        <div class="container my-5" style="display: flex; position: relative;">
            <div class="row p-4">
                <div class="image-container col-md-6" style="flex: 1;">
                    <img src="{{ asset('assets/img/coffee.jpg') }}" alt="Your Image" class="img-fluid" style="width: auto; height: 100%;">
                </div>
                <div class="text-container my-4 me-4" 
